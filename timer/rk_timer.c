...
#define RK_TIMER_MAGIC           't'
#define RK_TIMER_START           _IO(RK_TIMER_MAGIC, 0x01)
#define RK_TIMER_STOP            _IO(RK_TIMER_MAGIC, 0x02)
#define RK_TIMER_SET_INTERVAL    _IOW(RK_TIMER_MAGIC, 0x03, unsigned int)
